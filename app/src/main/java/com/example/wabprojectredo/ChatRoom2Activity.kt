...
import kotlinx.android.synthetic.main.activity_chat_room2.*
...
class ChatRoom2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edittxt_cr2_messageentry.setOnKeyListener(View.OnKeyListener { v, keyCode, event ->
        ...
        /*btn_cr2_send.setOnClickListener {
            Log.d(TAG, "Attempt to send message..")
            performSendMessage()
        }*/
    }
    ...
    private fun listenForMessages(){
        ...
        val ref = FirebaseDatabase.getInstance().getReference("/chats/cyberbullyingchatroom").limitToLast(100)
        ...
        ref.addChildEventListener(object: ChildEventListener {
            override fun onChildAdded(p0: DataSnapshot, p1: String?) {
                ...
                recyclerview_cr2_messages.scrollToPosition(adapter.itemCount - 1)
            }
    ...
    private fun performSendMessage(){
        val text = edittxt_cr2_messageentry.text.toString()
        ...
        if (text != "" && text != " " && text != "   ") {
            ...
            val reference = FirebaseDatabase.getInstance().getReference("/chats/cyberbullyingchatroom").push()
            ...
            reference.setValue(chatMessage)
                .addOnSuccessListener {
                    ...
                    edittxt_cr2_messageentry.text.clear()
                }
        }
        else {
